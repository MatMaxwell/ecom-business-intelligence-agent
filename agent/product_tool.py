...
# Rules based on Generic E-Commerce Company Master Policy Compendium.
# Standard return window is 30 days per Section 4.1.
# Category-specific exceptions are operational standards.
PRODUCT_RULES = {
    "electronics": {
    ...
    "food": {
        ...
        "restocking_fee_pct": 0,
        "requires_manager_approval_above": 999999,
        "notes": "Perishable items are classified as high-risk category under Section 4.2 and are not eligible for standard return.",
    },
    "toys": {
        "return_window_days": 30,
        "restocking_fee_pct": 0,
    ...
    "home": {
        ...
        "notes": "Large or bulky items may qualify for returnless refund under Section 4.2 if logistics cost exceeds 60% of resale value.",
    },
    "beauty": {
        "return_window_days": 30,
        "restocking_fee_pct": 0,
